...
// // ConfigMap
// import ConfigMapComponent from "./configmap/configmap";

// // Secret
// import SecretComponent from "./secrets/secret";
...
// // ─────────────────────────────────────────────
// // ConfigMap meta config (lime accent)
// // ─────────────────────────────────────────────

// const configMapMeta = {
//   "configmap": {
//     label: "ConfigMaps",
//     subtitle: "v1 · ConfigMap",
//     accent: "#84cc16",           // lime
//     accentDim: "rgba(132,204,22,0.15)",
//     accentBorder: "rgba(132,204,22,0.3)",
//     accentShadow: "rgba(132,204,22,0.35)",
//     glow: "rgba(132,204,22,0.18)",
//     gradient: "linear-gradient(135deg, #84cc16 0%, #65a30d 100%)",
//     stripeGradient: "linear-gradient(90deg, #84cc16, #bef264)",
//     tags: ["Key‑Value", "Env Injection", "Decouple Config"],
//     desc: "Externalize non‑sensitive configuration as key‑value pairs. Mount as environment variables or volumes to keep images portable.",
//     icon: <ConfigMapIcon />,
//   },
// };

// // ─────────────────────────────────────────────
// // Secret meta config (rose/red accent)
// // ─────────────────────────────────────────────
...
//     stripeGradient: "linear-gradient(90deg, #e11d48, #fda4af)",
//     tags: ["Base64", "Passwords", "Tokens"],
//     desc: "Store sensitive configuration like passwords, tokens, and keys. Automatically base64‑encoded and injected as environment variables or volumes.",
//     icon: <SecretIcon />,
//   },
// };
...
//       <div
//         className="k8s-card"
//         onClick={() => setActiveView("configmap")}
//         style={{
//           backgroundColor: isDark ? "rgba(15,23,42,0.9)" : "#ffffff",
//           border: `1px solid ${isDark ? "rgba(132,204,22,0.35)" : "rgba(132,204,22,0.28)"}`,
//           boxShadow: isDark
//             ? "0 4px 24px rgba(0,0,0,0.4)"
//             : "0 4px 24px rgba(132,204,22,0.1)",
//         }}
//       >
//         <div
//           className="k8s-stripe"
//           style={{ background: "linear-gradient(90deg, #84cc16, #bef264)" }}
//         />
//         <div
//           className="k8s-card-glow"
//           style={{
...
//                 ConfigMaps
//               </p>
//               <p className="k8s-card-desc" style={{ color: "#84cc16" }}>
//                 v1 · ConfigMap
//               </p>
//             </div>
//           </div>
...
//           <p className="k8s-card-desc" style={{ color: textDesc }}>
//             Externalize non‑sensitive configuration as key‑value pairs. Mount as
//             environment variables or volumes to keep images portable.
//           </p>

//           <div
//             style={{ display: "flex", gap: 8, marginTop: 16, flexWrap: "wrap" }}
//           >
//             {["Key‑Value", "Env Injection", "Decouple Config"].map((tag) => (
//               <span
//                 key={tag}
//                 style={{
//                   fontFamily: "'Space Mono', monospace",
...
//         <div
//           className="k8s-stripe"
//           style={{ background: "linear-gradient(90deg, #e11d48, #fda4af)" }}
//         />
//         <div
//           className="k8s-card-glow"
//           style={{
...
//           <p className="k8s-card-desc" style={{ color: textDesc }}>
//             Store sensitive configuration like passwords, tokens, and keys.
//             Automatically base64‑encoded and injected as environment variables
//             or volumes.
//           </p>
...
//             style={{ display: "flex", gap: 8, marginTop: 16, flexWrap: "wrap" }}
//           >
//             {["Base64", "Passwords", "Tokens"].map((tag) => (
//               <span
//                 key={tag}
//                 style={{
//                   fontFamily: "'Space Mono', monospace",
...
// ─────────────────────────────────────────────
// Meta configs for all selection grids
// ─────────────────────────────────────────────
...
const GLOBAL_STYLES = `
  ...
  @media (max-width: 768px) {
    ...
    .cv-header-card .k8s-badge {
      font-size: 8px !important;
    }
    .k8s-card-inner > div:first-of-type > div:first-child {
      width: 40px !important;
      height: 40px !important;
    }
    .k8s-card-inner > div:first-of-type > div:first-child svg {
...
export default function FullViewK8s() {
  ...
  const pageWrap = (children: React.ReactNode) => (
    <div className="page-wrap" style={{ backgroundColor: bg }}>
      <style>{GLOBAL_STYLES}</style>
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>{children}</div>
    </div>
  );
