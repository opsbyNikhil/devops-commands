...
export default function FullViewK8s() {
  ...
  // ── VIEW: Individual EKS ClusterIP Deep Dive ──────────────────────────────
  ...
  // ── VIEW: Individual EKS NodePort Deep Dive ───────────────────────────────
  ...
  // ── VIEW: Individual EKS LoadBalancer Deep Dive ───────────────────────────
  ...
  // ── VIEW: Individual EKS ExternalName Deep Dive ───────────────────────────
      ...
      >
        ...
        <div className="k8s-card-inner">
          ...
          <div
            style={{ display: "flex", gap: 8, marginTop: 16, flexWrap: "wrap" }}
          >
            {["ClusterIP", "NodePort", "LoadBalancer", "ExternalName"].map((tag) => (
              <span
                key={tag}
                style={{
                  fontFamily: "'Space Mono', monospace",
