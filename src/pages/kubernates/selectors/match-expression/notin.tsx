...
const YamlLine = ({ line, isDark }: { line: string; isDark: boolean }) => {
  const colors = {
    ...
    highlight: isDark ? "#f87171" : "#dc2626", // red for NotIn operator
  };
...
// ----------------------------------------------
// Main component – NotIn operator (set‑based negation)
// ----------------------------------------------
const NotInSelector = () => {
...
spec:
  ...
  // Theme‑aware colour palette (red for NotIn, blue for secondary)
  const bg = isDark ? "#0f0a12" : "#fef2f2";
  ...
  // Primary accent = red (NotIn operator), secondary = blue
  const red = isDark ? "#f87171" : "#dc2626";
  const redAlpha = isDark ? "rgba(248,113,113,0.08)" : "rgba(220,38,38,0.06)";
  const redBorder = isDark ? "rgba(248,113,113,0.28)" : "rgba(220,38,38,0.2)";
  ...
  // Steps for NotIn operator usage
  const steps = [
    {
      id: 1,
      title: "Define matchExpressions with NotIn",
      description:
        "Use matchExpressions with operator: NotIn to exclude specific values.",
      cmd: "selector:\n  matchExpressions:\n  - key: app\n    operator: NotIn\n    values: [zomato, uber]",
      accentColor: red,
      accentBg: redAlpha,
      accentBorder: redBorder,
    },
    {
      id: 2,
      title: "Apply Deployment",
      description:
        "The Deployment will select all Pods where app is NOT zomato or uber.",
    ...
    },
    {
      ...
      description: "List Pods that are excluded from the blacklisted values.",
      cmd: "kubectl get pods -l 'app notin (zomato, uber)'",
      accentColor: red,
      accentBg: redAlpha,
      accentBorder: redBorder,
    },
  ...
  // Selection matrix data (opposite of In)
  const scenarios = [
    {
      label: "app: zomato",
      selected: false,
  ...
  return (
    ...
    >
      <style>{`
        ...
        .notin-pulse       { animation: pulse-glow 2s ease-in-out infinite; }
        .notin-arrow       { animation: arrow-fade 2s ease-in-out infinite; }
        .notin-copy:hover  { color:${red} !important; border-color:${redBorder} !important; }
        .notin-step:hover  { background:${redAlpha} !important; transform:translateX(2px); }
        .notin-row:hover   { background:${redAlpha} !important; transform:translateX(3px); }
      `}</style>
        ...
        >
          ...
          >
            <div>
              ...
              >
                <span style={{ color: red }}>NotIn</span> Operator
              </div>
              ...
              >
                ...
                . This is the set‑based opposite of <code>In</code> — ideal for
                exclusion rules and blacklisting.
              </div>
            </div>
          ...
          >
            ...
            <div>
              ...
              >
                {[
                  ...
                  {
                    label: "operator: NotIn",
                    bg: redAlpha,
                    border: redBorder,
                    color: red,
                  },
                  {
                    label: "set‑based negation",
                    bg: purpleAlpha,
                    border: t(
            ...
            >
              ...
              <p style={{ fontSize: 12.5, color: txtSec, lineHeight: 1.6 }}>
                The <code>NotIn</code> operator matches if the label is{" "}
                <strong>missing</strong> or its value is not in the set. This is
                often used for default/fallback behavior, unlike <code>In</code>{" "}
                which requires the label to exist with a matching value.
              </p>
            </div>
            ...
            >
              ...
              <span>kubectl get pods -l 'app notin (zomato, uber)'</span>
              <span style={{ color: txtMuted }}>·</span>
          ...
          >
            ...
            <div>
              ...
              >
                <div style={{ display: "flex", alignItems: "stretch" }}>
                  {(
                    [
                      ...
                      { icon: "🔍", label: "Check\nNotIn", accent: true },
                      { icon: "🚫", label: "Not in set?", accent: false },
                    ] as const
                  ).map((step, idx, arr) => (
                    <div
                      key={idx}
                    ...
                    >
                      <div
                        style={{
                          ...
                          border: `1px solid ${step.accent ? redBorder : divider}`,
                          borderRadius: 10,
                          padding: "12px 6px",
                        }}
                      >
                ...
                >
                  <span style={{ color: red }}>✓</span> Pods where{" "}
              ...
              >
                {scenarios.map((s, i) => (
                  ...
                  >
                    ...
                    <span
                      style={{
                        background: s.selected ? redAlpha : "transparent",
                        color: s.selected ? red : txtMuted,
                        fontSize: 11,
                        fontWeight: 500,
                        padding: "4px 14px",
                        borderRadius: 24,
            ...
            <div>
              ...
              >
                ...
                >
                  Use NotIn for exclusion rules
                </div>
                <p style={{ fontSize: 13, color: txtSec, lineHeight: 1.6 }}>
                  The <code>NotIn</code> operator is perfect when you need to{" "}
                  <strong>exclude specific values</strong> (blacklisting). It
                  also matches missing labels – useful for default routes or
                  fallback behavior. Combine with <code>In</code> for
                  whitelisting logic.
                </p>
              </div>
            </div>
