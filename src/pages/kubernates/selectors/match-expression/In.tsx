...
spec:
  ...
  const accentGreen = isDark ? "#34d399" : "#059669"; // using green for "In"
  ...
  // Matrix: which label values are selected
  const scenarios = [
      ...
      >
        ...
        >
          ...
          >
            ...
            <strong style={{ color: accentGreen }}>
        ...
        >
          ...
          >
            <div>
              ...
              >
                The <code>In</code> operator matches if the label value is equal
                to <strong>any</strong> of the specified values. This is the
                set‑based equivalent of equality using multiple options.
              </p>
              <div
                style={{
                  display: "flex",
              ...
              >
                {["Set-based", "Multi-value", "Flexible"].map((tag) => (
                  <span
                    key={tag}
                    style={{
                      background: tagBg,
            ...
            >
              ...
              >
                kubectl get pods -l 'app in (zomato, uber)'
              </code>
            </div>
          </div>
          ...
          >
            ...
            <div>
              ...
              >
                ...
                >
                  <span style={{ color: accentGreen }}>✓</span> Pods with{" "}
