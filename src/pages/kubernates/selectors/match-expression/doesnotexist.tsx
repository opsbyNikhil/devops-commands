...
// ----------------------------------------------
// Main component – DoesNotExist operator
// ----------------------------------------------
...
spec:
  ...
  // Theme colours – using pink/rose for "DoesNotExist"
  ...
  const accentPinkLight = isDark
    ? "rgba(249,168,212,0.08)"
    : "rgba(219,39,119,0.06)";
  const accentPinkBorder = isDark
    ? "rgba(249,168,212,0.2)"
    : "rgba(219,39,119,0.15)";
  const accentBlue = isDark ? "#7dd3fc" : "#0284c7";

  // Matrix: DoesNotExist selects only when the key is completely absent
  const scenarios = [
    {
  ...
  return (
    ...
    >
      <style>{`
        ...
        .copy-btn:hover {
          background: ${accentPinkLight} !important;
          border-color: ${accentPink} !important;
        }
        .scenario-row:hover {
          background: ${accentPinkLight} !important;
        }
        ...
        >
          ...
          >
            <div>
              ...
              >
                The <code>DoesNotExist</code> operator matches only if the label
                key is <strong>completely missing</strong>. The{" "}
                <code>values</code> field is ignored even if provided.
              </p>
              <div
                style={{
                  display: "flex",
              ...
              >
                ...
                <button
                  ...
                  style={{
                    ...
                    borderRadius: "8px",
                    color: copied ? accentPink : textMuted,
                    fontSize: "11px",
                    padding: "5px 14px",
                    cursor: "pointer",
                    display: "flex",
            ...
            <div
              style={{
                ...
                border: `1px solid ${accentPinkBorder}`,
                borderRadius: "14px",
                padding: "12px 16px",
                display: "flex",
                alignItems: "center",
              ...
              >
                ...
                >
                  {[
                    ...
                    { title: "Check DoesNotExist", icon: "🔍" },
                    { title: "Key absent?", icon: "❌" },
                  ].map((step, idx) => (
                    <div
                      key={step.title}
                    ...
                    >
                      <div
                        style={{
                          background: idx === 2 ? accentPinkLight : tagBg,
                          border:
                            idx === 2
                              ? `1px solid ${accentPinkBorder}`
                              : `1px solid ${tagBorder}`,
                          borderRadius: "16px",
                          padding: "14px 8px",
                        }}
                      >
                        ...
                        <div
                          style={{
                            fontSize: "12px",
                            fontWeight: 450,
                            color: idx === 2 ? accentPink : textSecondary,
                          }}
                        >
                          {step.title}
                        </div>
                ...
                >
                  <span style={{ color: accentPink }}>✓</span> Only pods{" "}
                    ...
                    <span
                      style={{
                        background: s.selected
                          ? accentPinkLight
                          : "transparent",
                        color: s.selected ? accentPink : textMuted,
                        fontSize: "11px",
                        fontWeight: 500,
                        padding: "4px 14px",
                        borderRadius: "24px",
